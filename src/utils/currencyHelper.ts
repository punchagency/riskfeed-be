...
export class CurrencyHelper {
    ...
    static async convertPrice(
        ...
        const amountInUSD = await this.convertToUSD(amount, from);
        const convertedAmount = await this.convertFromUSD(amountInUSD, to);
    ...
    static async convertPriceToUserCurrency(
        ...
        const amountInUSD = await this.convertToUSD(amount, from);
        return await this.convertFromUSD(amountInUSD, to);
    }
